...
function Redis (opts) {
  ...
  var isRedisSentinelClient = function( o ) {
    return !! ( o && o.constructor &&  o.constructor.name == 'RedisSentinelClient' );
  };

  // initialize a pubsub client and a regular client
  if (opts.redisPub instanceof RedisClient || isRedisSentinelClient( opts.redisPub ) ) {
  ...
  if (opts.redisSub instanceof RedisClient || isRedisSentinelClient( opts.redisSub ) ) {
  ...
  if (opts.redisClient instanceof RedisClient || isRedisSentinelClient( opts.redisClient ) ) {
